  ...
  return (
    <div className='flex flex-col lg:flex-row space-y-8 lg:space-y-0 items-center justify-between max-w-[1240px] mx-auto px-4 py-6'>
        <div className='flex flex-col space-y-8'>
            <h1 className='monument text-5xl lg:text-6xl text-center lg:text-left'>Summer <br /> Collection</h1>
            ...
            <div className="w-full flex items-center justify-center lg:justify-start">
                <a className='bg-redor text-white font-semibold py-2 px-4 flex items-center w-fit rounded hover:bg-black transition-all duration-300'>
                    Shop Now
